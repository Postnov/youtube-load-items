...
function YoutubeLazyLoad(selector, params) {
    ...
    var options = {
        ...
        youtubeIcon: params.youtubeIcon || 'http://icons.iconarchive.com/icons/dakirby309/simply-styled/128/YouTube-icon.png'
    }
        ...
        nodes.forEach(function(item, i) {
            ...
            if (options.imgWrapPath !== false) {
                ...
                if(options.youtubeIcon) {
                    var icon = yllCreateElement('img', {src: options.youtubeIcon}, 'yll__youtube-icon', undefined, undefined);
